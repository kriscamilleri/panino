          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4 pt-8 border-t">
              ...
              <div class="space-y-2">
                ...
                <textarea id="printHeaderHtml" rows="4" v-model="printHeaderHtmlLocal"
                  @input="updatePrintHeader(printHeaderHtmlLocal)" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                           focus:outline-none focus:ring-gray-500 focus:border-gray-500
                           sm:text-sm font-mono"
                  placeholder="Optional HTML to appear at the top of printed pages"></textarea>
              </div>
              ...
              <div class="space-y-2">
                ...
                <textarea id="printFooterHtml" rows="4" v-model="printFooterHtmlLocal"
                  @input="updatePrintFooter(printFooterHtmlLocal)" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                           focus:outline-none focus:ring-gray-500 focus:border-gray-500
                           sm:text-sm font-mono"
                  placeholder="Optional HTML to appear at the bottom of printed pages"></textarea>
              </div>
            </div>
          </div>
        </div>
