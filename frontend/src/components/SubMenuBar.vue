<template>
    ...
    >
        <div
            v-if="ui.isAnyMenuOpen"
            class="workspace-chrome border-y bg-gray-50 px-4 py-2 min-h-14 flex items-center overflow-x-auto"
        ...
        >
            ...
            <div
                v-else-if="ui.showActionBar"
                class="flex flex-wrap items-center gap-2"
                :class="{ 'editor-menu-collapsed': ui.editorMenuCollapsed }"
                key="editor"
            >
                <button
                    @click="triggerUndo"
                ...
                <BaseButton
                    :isActive="ui.showStats"
                    @click="ui.toggleStats()"
                    data-testid="submenu-editor-stats"
                    title="Toggle Stats"
                    class="text-sm"
                >
                ...
                <BaseButton
                    :isActive="ui.showMetadata"
                    @click="ui.toggleMetadata()"
                ...
                <BaseButton
                    :isActive="ui.editorMenuCollapsed"
                    @click="ui.toggleEditorMenuCollapsed()"
                    title="Collapse/Expand Menu"
                    data-testid="submenu-editor-collapse"
                    class="text-sm"
                >
                    <PanelLeftClose
                        v-if="!ui.editorMenuCollapsed"
                        class="w-4 h-4"
                    />
                    <PanelLeftOpen
                        v-else
