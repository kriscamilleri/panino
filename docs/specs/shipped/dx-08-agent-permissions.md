...
> Status: shipped — verified 2026-08-16. `.claude/settings.json` is committed with the shared
...
> Implementation: `.claude/settings.json`, `.gitignore` (`.claude/settings.local.json`), `AGENTS.md` §4
